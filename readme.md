...
│ └── evidence/
│ └── <session_id>/
│ └── frame_*.jpg # Cheating proof frames
│
├── requirements.txt
└── README.md
...
- 👄 Mouth movement detection (talking / whispering)  
- 👥 Multiple face detection  
- 📱 Object detection (phone, book, notes, etc.)  
- 🎤 Optional audio speaker consistency check  
- 🖼️ Automatic saving of cheating proof frames  
